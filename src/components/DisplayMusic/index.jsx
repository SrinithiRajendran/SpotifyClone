...
const DisplayMusic = () => {
  ...
  const isAlbum = location.pathname.includes("album") || location.pathname.includes("throwback")
  ...
  return (
    <div className='text-white overflow-auto w-[100%] m-2 px-6 pt-4 lg:w-[75%] lg:ml-0 rounded bg-[#121212]' ref={displayRef}>
          <Routes>
