        ...
        <>
            <div className='flex justify-between items-center w-full font-semibold'>
                <div className='flex items-center gap-2'>
                    <MdNavigateBefore className='rounded-full bg-black text-2xl md:text-3xl p-1 cursor-pointer' onClick={() => navigate(-1)} />
                    <MdNavigateNext className='bg-black text-2xl md:text-3xl p-1 rounded-full cursor-pointer' onClick={() => navigate(1)} />
                </div>
            ...
            <div className='flex items-center gap-2 sm:gap-3 md:gap-4 mt-4 cursor-pointer'>
                <p
                    className={`px-3 sm:px-4 py-1 text-[12px] sm:text-[13px] md:text-[15px] rounded-2xl ${activeTab === 'All' ? 'bg-white text-black' : 'bg-black text-white'}`}
                    onClick={() => handleTabClick('All')}
                >
                    All
                </p>
                <p
                    className={`px-3 sm:px-4 py-1 text-[12px] sm:text-[13px] md:text-[15px] rounded-2xl ${activeTab === 'Music' ? 'bg-white text-black' : 'bg-black text-white'}`}
                    onClick={() => handleTabClick('Music')}
                >
                    Music
                </p>
                <p
                    className={`px-3 sm:px-4 py-1 text-[12px] sm:text-[13px] md:text-[15px] rounded-2xl ${activeTab === 'Podcasts' ? 'bg-white text-black' : 'bg-black text-white'}`}
