...
const ExplorePremium = () => {
  return (
      <>
        <div class="text-white p-8 rounded-lg bg-gradient-to-r from-pink-900 to-blue-900">
          ...
          <div class="flex flex-col sm:flex-row items-center gap-4 mb-4 ">
            <button class="bg-white text-xs md:text-sm text-black px-6 py-2 rounded-full font-semibold hover:bg-gray-200 transition duration-300">
              Get Premium Individual
            </button>
            <button class="bg-transparent border text-xs md:text-sm border-white text-white px-6 py-2 rounded-full font-semibold hover:bg-white hover:text-black transition duration-300">
              View all Plans
            </button>
          </div>
          <p class="text-xs sm:text-sm md:text-base">
            ₹119 for 2 months, then ₹119 per month after. Offer only available if you haven't tried Premium before. 
            <a href="#" class="underline">Terms apply.</a>
          </p>
        </div>
        ...
        <div class="text-center p-4 mt-8 mb-8">
          ...
          <div class="flex flex-wrap justify-center gap-2">
            <div class="w-14 h-11 p-2 rounded-lg shadow-md bg-white flex items-center justify-center">
              <img class="w-10 h-10 object-contain" src="https://w7.pngwing.com/pngs/73/360/png-transparent-india-bhim-unified-payments-interface-mobile-phones-india.png" alt="BHIM UPI"/>
            </div>
            <div class="w-14 h-11 p-2 rounded-lg shadow-md bg-white flex items-center justify-center">
              <img class="w-10 h-10 object-contain" src="https://w7.pngwing.com/pngs/506/509/png-transparent-google-company-text-logo.png" alt="Google Pay"/>
            </div>
            <div class="w-14 h-11 p-2 rounded-lg shadow-md bg-white flex items-center justify-center">
              <img class="w-10 h-10 object-contain" src="https://w7.pngwing.com/pngs/332/615/png-transparent-phonepe-india-unified-payments-interface-india-purple-violet-text.png" alt="PhonePe"/>
            </div>
            <div class="w-14 h-11 p-2 rounded-lg shadow-md bg-white flex items-center justify-center">
              <img class="w-10 h-10 object-contain" src="https://w7.pngwing.com/pngs/305/719/png-transparent-paytm-ecommerce-shopping-social-icons-circular-color-icon.png" alt="Paytm"/>
            </div>
          </div>
      </div>
    ...
    <div className="max-w-xs mx-auto p-4 md:p-6 mb-10 bg-[#242424] shadow-lg text-white">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-[#d5f261]">Mini</h1>
        <p className="text-base font-bold mt-4 mb-4">₹29 for 1 week</p>
        <hr className="border-gray-300 mb-4" />
        <ul className="mb-4 space-y-2 list-disc pl-5">
            <li className="text-sm text-white">1 mobile-only Premium account</li>
            <li className="text-sm text-white">Offline listening of up to 30 songs on 1 device</li>
    ...
    <div className="max-w-xs mx-auto p-4 md:p-6 mb-10 bg-[#242424] shadow-lg text-white">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-[#fabbbb]">Individual</h1>
        <p className="text-base font-bold mt-4 ">₹119 for 2 months</p>
        <p className='text-gray-200 text-xs mb-4 font-bold'>₹119 / month after</p>
        <hr className="border-gray-300 mb-4" />
        <ul className="mb-4 space-y-2 list-disc pl-5">
            <li className="text-sm text-white">1 Premium account</li>
            <li className="text-sm text-white">Cancel anytime</li>
            <li className="text-sm text-white">Subscribe or one-time payment</li>
        </ul>
    ...
    <div className="max-w-xs mx-auto p-4 md:p-6 mb-10 bg-[#242424] shadow-lg text-white">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-[#aedaec]">Family</h1>
        <p className="text-base font-bold mt-4 ">₹179 for 2 months</p>
        <p className='text-gray-200 text-xs mb-4 font-bold'>₹179 / month after</p>
        <hr className="border-gray-300 mb-4" />
        <ul className="mb-4 space-y-2 list-disc pl-5">
            <li className="text-sm text-white">Up to 6 Premium accounts</li>
            <li className="text-sm text-white">Control content marked as explicit</li>
            <li className="text-sm text-white">Cancel anytime</li>
            <li className="text-sm text-white">Subscribe or one-time payment</li>
        </ul>
    ...
    <div className="max-w-xs mx-auto p-4 md:p-6 mb-10 bg-[#242424] shadow-lg text-white">
        ...
        <p className='text-gray-200 text-xs mb-4 font-bold'>₹149 / month after</p>
        <hr className="border-gray-300 mb-4" />
        <ul className="mb-4 space-y-2 list-disc pl-5">
    ...
    <div className="max-w-xs mx-auto p-4 md:p-6 mb-10 bg-[#242424] shadow-lg text-white">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-[#dabee8]">Student</h1>
        <p className="text-base font-bold mt-4 ">₹59 for 2 months</p>
        <p className='text-gray-200 text-xs mb-4 font-bold'>₹59 / month after</p>
        <hr className="border-gray-300 mb-4" />
        <ul className="mb-4 space-y-2 list-disc pl-5">
            <li className="text-sm text-white">1 verified Premium account</li>
            <li className="text-sm text-white">Discount for eligible students</li>
            <li className="text-sm text-white">Cancel anytime</li>
            <li className="text-sm text-white">Subscribe or one-time payment</li>
        </ul>
